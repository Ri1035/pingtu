...
| v1.7.0 | 4e5f4b0 | 长拼图模块（纵向堆叠 + 模糊边缘 + 文字/水印复用 + 切片导出）+ 头像压缩优化 |
| v1.8.0 | edb946f | 长拼图可用素材库；文字画布拖拽 + 新文字落当前段 + 水平/垂直变形 |
| v1.9.0 | 317d445 | 文字斜切 + 变形预设 + 长图 base/overlay 图层缓存与拖拽节流 + 素材插入长图指定位置 |
