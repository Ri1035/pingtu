...
const zh: Record<string, Value> = {
  ...
  // —— 长拼图 ——
  longUpload: '上传图片',
  longUploadHint: '按加入顺序纵向堆叠，顺序即长图从上到下的次序',
  longNoImage: '还没有图片，点击上方按钮上传',
  longStack: '图片顺序',
  longMoveUp: '上移',
  longMoveDown: '下移',
  longRemove: '移除',
  longCanvasWidth: '画布宽度',
  longWidthHint: '电商详情页常用 750，公众号正文常用 1080',
  longFeather: '模糊边缘',
  longFeatherHint: '相邻两张图交界处重叠并渐隐过渡；值越大衔接越柔和，0 为硬拼接',
  longTitle: '顶部标题',
  longTitleText: '标题文字',
  longTitleColor: '标题颜色',
  longTitleSize: '标题字号',
  longSectionImages: '图片',
  longSectionStyle: '样式',
  longSectionExport: '导出',
  longSlice: '切片导出',
  longSliceHint: '整图过高时切成多段下载，便于分屏上传到平台',
  longSegment: '每段高度',
  longTotalHeight: '总高',
  ...
  longInsertPick: '点击选择此位置，素材库图片将插入到它之后',
  longInsertHint: '点击上方某张图，可让素材库图片插入到它之后（默认追加到末尾）',
  longInsertActive: (n) => `素材库图片将插入到第 ${n} 张之后，点击素材的「加入拼图」即可插入`,
  longInsertCancel: '取消选择',
  textDeformX: '水平变形',
  textDeformY: '垂直变形',
  textSkew: '斜切',
  deformPreset: '变形预设',
...
const en: Record<string, Value> = {
  ...
  tabExport: 'Export',
  tabAssets: 'Library',
  tabLong: 'Long Collage',

  // —— Long collage ——
  longUpload: 'Upload images',
  longUploadHint: 'Images stack vertically in the order added (top to bottom)',
  longNoImage: 'No images yet — click the button above to upload',
  longStack: 'Image order',
  longMoveUp: 'Up',
  longMoveDown: 'Down',
  longRemove: 'Remove',
  longCanvasWidth: 'Canvas width',
  longWidthHint: '750 is common for e-commerce, 1080 for article bodies',
  longFeather: 'Feather edges',
  longFeatherHint: 'Adjacent images overlap and fade into each other; larger = softer seam, 0 = hard seam',
  longTitle: 'Top title',
  longTitleText: 'Title text',
  longTitleColor: 'Title color',
  longTitleSize: 'Title size',
  longSectionImages: 'Images',
  longSectionStyle: 'Style',
  longSectionExport: 'Export',
  longSlice: 'Slice export',
  longSliceHint: 'Cuts an overly tall image into segments for easier upload',
  longSegment: 'Segment height',
  ...
  longInsertPick: 'Click to set this as the insertion point',
  longInsertHint: 'Click a photo above to insert library images after it (default: append to end)',
  longInsertActive: (n) => `Library images will be inserted after photo #${n} — tap "Add to collage" to insert`,
  longInsertCancel: 'Cancel',
  textDeformX: 'Deform X',
  textDeformY: 'Deform Y',
  textSkew: 'Skew',
  deformPreset: 'Deform presets',
  deformNormal: 'Normal',
  deformWide: 'Wide',
  deformTall: 'Tall',
  deformFlat: 'Flat',
  deformSlantL: 'Slant L',
  deformSlantR: 'Slant R',
